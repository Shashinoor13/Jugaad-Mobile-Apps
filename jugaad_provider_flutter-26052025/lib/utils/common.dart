...
Future<void> setSaveSubscription({int? isSubscribe, String? title, String? identifier, String? endAt, required bool isVerifiedPlan}) async {
  ...
  await appStore.setVerifiedPlanStatus(isVerifiedPlan);
}
...
Widget mobileNumberInfoWidget(BuildContext context) {
  return RichTextWidget(
    list: [
      ...
      TextSpan(text: ' "91-", "977-" ', style: boldTextStyle(size: 12)),
      TextSpan(
