...
import '../../components/wallet_balance_component.dart';
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void init() async {
    future = getPaymentGateways(requireCOD: false, requireWallet: true);
  }
              ...
              return Column(
                ...
                children: [
                  ...
                  AppButton(
                    ...
                    text:
                        'Proceed to Pay (${isCurrencyPositionLeft ? appConfigurationStore.currencySymbol : ''}'
                        '${widget.selectedPricingPlan.isVerifiedPlan! ? (widget.selectedPricingPlan.amount! + int.parse(widget.selectedPricingPlan.plansVerifiedProviders!.verifiedProviderAmount!)) : widget.selectedPricingPlan.amount}${isCurrencyPositionRight ? appConfigurationStore.currencySymbol : ''})',
                    color: context.primaryColor,
                    width: context.width(),
                  ).paddingAll(16),
                ],
