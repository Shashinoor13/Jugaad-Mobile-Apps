...
class DashboardResponse {
  ...
  List<UserData>? verifiedProvider;
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    return DashboardResponse(
      ...
      verifiedProvider: json['verified_provider_list'] != null ? (json['verified_provider_list'] as List).map((i) => UserData.fromJson(i)).toList() : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.verifiedProvider != null) {
      data['verified_provider_list'] = this.verifiedProvider!.map((v) => v.toJson()).toList();
    }
