...
class _AddServicesState extends State<AddServices> {
  ...
  List<StaticDataModel> typeStaticData = [
    ...
    StaticDataModel(key: SERVICE_TYPE_SQ_FT, value: languages.lblSqft),
    StaticDataModel(key: SERVICE_TYPE_RUNNING_FT, value: languages.lblRunningFt),
    StaticDataModel(key: SERVICE_TYPE_POINT, value: languages.lblPoint),
    StaticDataModel(key: SERVICE_TYPE_DAY, value: languages.lblDay),
    StaticDataModel(key: SERVICE_TYPE_JOB, value: languages.lblJob),
    StaticDataModel(key: SERVICE_TYPE_NEGOTIABLE, value: languages.lblNegotiable),
  ];
  ...
  StaticDataModel get getServiceType {
    switch (serviceType) {
      case SERVICE_TYPE_FIXED:
        return typeStaticData[0];
      case SERVICE_TYPE_HOURLY:
        return typeStaticData[1];
      case SERVICE_TYPE_SQ_FT:
        return typeStaticData[2];
      case SERVICE_TYPE_RUNNING_FT:
        return typeStaticData[3];
      case SERVICE_TYPE_POINT:
        return typeStaticData[4];
      case SERVICE_TYPE_DAY:
        return typeStaticData[5];
      case SERVICE_TYPE_JOB:
        return typeStaticData[6];
      case SERVICE_TYPE_NEGOTIABLE:
        return typeStaticData[7];
      default:
        return typeStaticData[0];
    }
  }
