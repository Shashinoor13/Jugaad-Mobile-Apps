...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$setUserStatusAsyncAction = AsyncAction('_AppStore.setUserStatus', context: context);

  @override
  Future<void> setUserStatus(int val) {
    return _$setUserStatusAsyncAction.run(() => super.setUserStatus(val));
  }
