...
abstract class _AppStore with Store {
  ...
  @observable
  int? userStatus = getIntAsync(USER_STATUS);

  @observable
  String userReferralCode = getStringAsync(REFERRAL_CODE);
  ...
  @observable
  bool isVerifiedPlan = getBoolAsync(IS_VERIFIED_PLAN);
  ...
  @action
  Future<void> setVerifiedPlanStatus(bool val) async {
    isVerifiedPlan = val;
    await setValue(IS_PLAN_SUBSCRIBE, val);
  }
  ...
  @action
  Future<void> setUserStatus(int val) async {
    userStatus = val;
    await setValue(USER_STATUS, val);
  }
