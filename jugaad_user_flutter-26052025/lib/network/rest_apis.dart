...
Future<void> saveUserData(UserData data) async {
  ...
  appStore.setReferralCode(data.referralCode.validate());
...
//region Verified Provider Api
Future<List<UserData>> getVerifiedProviderList(int page, {var perPage = PER_PAGE_ITEM, required List<UserData> providers, Function(bool)? lastPageCallBack}) async {
  try {
    ProviderListResponse res = ProviderListResponse.fromJson(await (handleResponse(await buildHttpResponse('verified-provider-list?per_page=$perPage&page=$page', method: HttpMethodType.GET))));
