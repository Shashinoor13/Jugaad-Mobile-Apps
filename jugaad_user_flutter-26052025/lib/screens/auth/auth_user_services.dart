...
void saveDataToPreference(BuildContext context, {required UserData userData, bool isSocialLogin = false, required Function onRedirectionClick}) async {
  ...
  await registerInFirebase(context, userData: userData, isSocialLogin: isSocialLogin);

  onRedirectionClick.call();
}

Future<void> registerInFirebase(BuildContext context, {required UserData userData, bool isSocialLogin = false}) async {
