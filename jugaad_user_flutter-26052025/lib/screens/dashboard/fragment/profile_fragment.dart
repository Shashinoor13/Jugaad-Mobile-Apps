                          ...
                          SettingItemWidget(
                            ...
                            onTap: () {
                              if (appConfigurationStore.onlinePaymentStatus) {
                                // UserWalletBalanceScreen().launch(context); /ACME disable wallet balance screen
                              }
                            },
                            trailing: Text(
                    ...
                    items: [
                      ...
                      if (appStore.userReferralCode.isNotEmpty)
                        SettingItemWidget(
                          ...
                          title: 'Refer & Earn',
                          onTap: () {
                            var strMsg = "https://wa.me/?text=I am referring you E-HomeSolution app"
                                " and so if you will register using my referral code : "
                                + appStore.userReferralCode +" and I will get Rs.100. "
                                "Download App now - " + getStringAsync(CUSTOMER_PLAY_STORE_URL);
