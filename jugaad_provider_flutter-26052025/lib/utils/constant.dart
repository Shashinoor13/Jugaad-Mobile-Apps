...
const APP_PACKAGE_NAME = "com.ehomesolutions.provider";

//region Configs
const DECIMAL_POINT = 2;
const PER_PAGE_ITEM = 25;
const PER_PAGE_ITEM_ALL = 'all';
const PLAN_REMAINING_DAYS = 5;
...
const IS_VERIFIED_PLAN = 'is_verified_plan';
...
const SERVICE_TYPE_SQ_FT = 'sq_ft';
const SERVICE_TYPE_RUNNING_FT = 'running+ft';
const SERVICE_TYPE_POINT = 'point';
const SERVICE_TYPE_DAY = 'day';
const SERVICE_TYPE_JOB = 'job';
const SERVICE_TYPE_NEGOTIABLE = 'negotiable';
