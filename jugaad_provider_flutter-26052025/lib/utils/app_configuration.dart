...
class AppConfigurationModel {
  ...
  String? adminAppMinimumVersion;
  String? adminAppLatestVersion;
  ...
  List<PaymentSetting>? paymentGateways;
  ...
  AppConfigurationModel.fromJsonMap(Map<String, dynamic> map)
      : siteName = map["site_name"],
        ...
        paymentGateways = map["payment_gateways"] != null ? List<PaymentSetting>.from(map["payment_gateways"].map((it) => PaymentSetting.fromJson(it))) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['payment_gateways'] = paymentGateways != null ? this.paymentGateways!.map((v) => v.toJson()).toList() : null;
    return data;
  }
}
