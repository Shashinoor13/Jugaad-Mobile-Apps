              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if(widget.data.isVerifiedPlan!=null)
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('Jugaad Provider',
                          style: secondaryTextStyle(size: 14, weight: FontWeight.normal),
                        ),
                        8.width,
                        Image.asset(ic_verified, height: 18, width: 18, color: verifyAcColor).visible(widget.data.isVerifiedPlan!),
                      ],
                    ).visible(widget.data.isVerifiedPlan!),
                    4.height,
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
