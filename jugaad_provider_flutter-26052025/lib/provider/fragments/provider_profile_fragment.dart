...
import 'package:handyman_provider_flutter/provider/subscription/subscription_details_screen.dart';
...
import '../subscription/pricing_plan_screen.dart';
            ...
            children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      4.width,
                      if (appStore.isVerifiedPlan)
                        CachedImageWidget(url: ic_verified, height: 16),
                      // 4.height,
                      // Text(appStore.userContactNumber, style: secondaryTextStyle()),
                    ],
                  ),
                ],
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                              GestureDetector(
                                onTap: () {
                                  SubscriptionDetailsScreen().launch(context);
                                },
                                child: Text(
                                  'Plan Details',
                                  style: boldTextStyle(
                              ...
                              AppButton(
                                child: Text('Upgrade', style: boldTextStyle(color: white, size: 12)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    16.height,
                    // if (appStore.earningTypeCommission) //ACME
                    ...
                    Divider(
                        ...
                        endIndent: 15.0,
                        color: context.dividerColor),
                    if (appStore.userReferralCode.isNotEmpty)
                      SettingItemWidget(
                        leading: ic_diagonal_right_up_arrow.iconImage(size: SETTING_ICON_SIZE),
                        title: 'Refer & Earn',
                        onTap: () {
                          var strMsg = "https://wa.me/?text=I am referring you E-HomeSolution Provider app"
                              " and so if you will register using my referral code : "
                              + appStore.userReferralCode +" and I will get Rs.100. "
                              "Download App now - " + getStringAsync(PROVIDER_PLAY_STORE_URL);
                          checkIfLink(context, strMsg, title: 'Refer & Earn');
                        },
                      ),
                    Divider(
                        height: 0,
