...
const HANDYMAN_APPROVED_CASH = "serviceman_approved_cash";
const HANDYMAN_SEND_PROVIDER = "serviceman_send_provider";
...
//region Status
const APPROVED_BY_HANDYMAN = "approved_by_serviceman"; //- Handyman approved the request
