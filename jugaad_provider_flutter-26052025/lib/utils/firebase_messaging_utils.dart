...
Future<void> subscribeToFirebaseTopic() async {
  if (appStore.isLoggedIn) {
    ...
    if (Platform.isIOS) {
      ...
      if (apnsToken != null) {
        ...
        if (isUserTypeHandyman) {
          FirebaseMessaging.instance.subscribeToTopic(HANDYMAN_APP_TAG);
        } else {
          FirebaseMessaging.instance.subscribeToTopic(PROVIDER_APP_TAG);
        }
      } else {
    ...
    log('ServiceMan Tag------> $HANDYMAN_APP_TAG');
    log('Provider Tag------> $PROVIDER_APP_TAG');
